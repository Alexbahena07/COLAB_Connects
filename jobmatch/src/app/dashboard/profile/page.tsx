...
export default async function StudentProfilePage() {
  ...
  return (
    <>
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-[--brand] via-[--background] to-[--background] px-4 pb-16 pt-10 text-[--foreground]">
        <div className="mx-auto w-full max-w-6xl space-y-8">
          {/* Hero band */}
          <div className="relative overflow-hidden rounded-3xl border border-white/20 bg-gradient-to-r from-[--brand] via-[--brandBlue] to-[--background] px-6 pb-6 pt-10 shadow-lg">
            ...
            <div className="relative flex flex-wrap items-start gap-6">
              {/* Avatar */}
              {userImage ? (
                <div className="relative h-28 w-28 flex-shrink-0 overflow-hidden rounded-3xl border-4 border-white/60 bg-[--surface] shadow-xl ring-2 ring-[--brandBlue]/50">
                  <Image
                    src={userImage}
                ...
                <div className="flex h-28 w-28 flex-shrink-0 items-center justify-center rounded-3xl bg-[--surface] text-3xl font-semibold text-[--brand] shadow-xl ring-2 ring-[--brandBlue]/40">
              ...
              <div className="rounded-3xl border border-[--brandBlue] bg-[--brandBlue] p-6 text-white shadow-sm">
                ...
                <dl className="mt-4 space-y-3 text-sm">
                  <div className="flex items-center justify-between">
                    <dt className="text-white/80">Applications submitted</dt>
                    <dd className="font-semibold">0</dd>
                  </div>
                  <div className="flex items-center justify-between">
                    <dt className="text-white/80">Skills listed</dt>
                    <dd className="font-semibold">{skills.length}</dd>
                  </div>
                  <div className="flex items-center justify-between">
                    <dt className="text-white/80">Experiences added</dt>
                    <dd className="font-semibold">{experiences.length}</dd>
                  </div>
                </dl>
                <p className="mt-4 text-[11px] uppercase tracking-wide text-white/70">
