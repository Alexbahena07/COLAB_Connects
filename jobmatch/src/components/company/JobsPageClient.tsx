  ...
  return (
      <main className="flex flex-1 flex-col bg-background text-foreground md:min-h-0 md:overflow-hidden">
        ...
        <PostsFilterBar
          ...
          subtitle="Review your open roles and publish new opportunities for students."
          switcher={switcher}
        />
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 md:min-h-0 md:flex-row md:overflow-hidden">
              ...
              {isLoadingJobs ? (
                ...
                <ul className="space-y-3">
                  {companyJobs.map((job) => {
                    ...
                    return (
                      <li key={job.id} className={listCardClass(isActiveEdit)}>
          ...
          <PostFormPanel
            ...
            badge={editingJobId && jobBeingEdited ? <EditingBadge label={jobBeingEdited.title} /> : null}
            onSubmit={handleSubmitJob}
            noValidate
          >
                {jobFormServerError ? <FormErrorBanner message={jobFormServerError} /> : null}

                {jobFormSuccess ? <FormSuccessBanner message={jobFormSuccess} /> : null}
